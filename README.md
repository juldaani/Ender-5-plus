...
For avoiding serious mental health issues with nano text editor when customizing printer.cfg, 

1. Install sshfs for mounting Raspberry's file system over SSH. Linux command: ```sudo apt install sshfs```
